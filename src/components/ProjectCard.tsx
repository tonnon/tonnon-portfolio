...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, index }) => {
  ...
  return (
    <a
      ...
      className="group block transition-[filter] duration-500 hover:[filter:drop-shadow(0_0_10px_rgba(168,85,247,0.35))_drop-shadow(0_0_28px_rgba(126,34,206,0.2))]"
    >
      <div
        ref={cardRef}
      ...
      >
        ...
        <div className="cyber-clip bg-gradient-to-br from-purple-500/50 via-purple-900/30 to-fuchsia-600/40 p-px transition-colors duration-500 group-hover:from-purple-400/90 group-hover:via-purple-500/40 group-hover:to-fuchsia-400/80">
          <div className="cyber-clip relative flex flex-col overflow-hidden bg-[#0b0613]/95 backdrop-blur-sm">
